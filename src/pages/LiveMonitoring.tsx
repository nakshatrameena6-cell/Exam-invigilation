...
const initialAnomalies: Anomaly[] = [
  {
    id: 'MAL-9104',
    severity: 'critical',
    title: 'Suspicious Talking & Verbal Communication at Back Row',
    malpracticeCategory: 'Talking / Verbal Interaction',
    description: 'Video Feed Timestamp 00:04s - 00:08s: AI 3D Audio-Visual Head Tracker flagged candidates STU-14 & STU-15 talking at back row.',
  ...
  },
  {
    id: 'MAL-9103',
    severity: 'critical',
    title: 'Side Head Turn (+62.4°) & Whispering Proximity',
    malpracticeCategory: 'Gaze / Head Turn Violation',
    description: 'Video Feed Timestamp 00:12s - 00:18s: PoseNet detected candidate turning head > 60° towards neighboring candidate desk.',
    camera: 'Hall A — Exam Room Main Feed (CAM-001)',
    studentId: 'STU-14',
    timestamp: '10:51:30 AM',
    confidence: 95.8,
    boxCoords: '[X:620, Y:280, W:240, H:440]',
  },
  {
    id: 'MAL-9102',
    severity: 'warning',
    title: 'Unauthorized Material / Paper Pass Trajectory',
    malpracticeCategory: 'Material Transfer Trajectory',
    description: 'Hand wrist keypoint trajectory detected note passing gesture between adjacent desks.',
    camera: 'Hall A — Exam Room Main Feed (CAM-001)',
    studentId: 'STU-15',
    timestamp: '10:48:05 AM',
    confidence: 92.4,
    boxCoords: '[X:740, Y:340, W:220, H:400]',
  },
  {
    id: 'MAL-9101',
    severity: 'critical',
    title: 'Secondary Person / Proxy Candidate Face Scan',
    malpracticeCategory: 'Identity / Impersonation',
    description: 'Biometric FaceEngine 96.2% mismatch against registered candidate roster for examinee seat.',
